...
var Accordion = /*#__PURE__*/function () {
  ...
  _createClass(Accordion, [{
    key: "_accordion",
    value: function _accordion() {
      var _this = this;

      var _loop = function _loop(i) {
        _this.DOM.faq[i].addEventListener("click", function () {
          _this.DOM.faq[i].children[0].classList.toggle("is-open");

          _this.DOM.faq[i].children[1].classList.toggle("is-open");
        });
      };

      for (var i = 0; i < this.DOM.faq.length; i++) {
        _loop(i);
      }
    }
  }]);
...
var Loading = /*#__PURE__*/function () {
  ...
  _createClass(Loading, [{
    ...
    value: function _init() {
      ...
      if (this.options.isLoad) {
        window.addEventListener("load", function () {
          _this.targetElem.classList.add("is-loaded");

          if (_this.introElem != null) {
            _this._loaded();
          }
        });
      }
    ...
    value: function _loaded() {
      ...
      setTimeout(function () {
        _this2.targetElem.classList.add("is-start");
      }, 1600);
    }
  }, {
    key: "_checkIos",
    value: function _checkIos() {
      var isIos = /iP(hone|(o|a)d)/.test(navigator.userAgent) || /iPad|Macintosh/i.test(navigator.userAgent) && "ontouchend" in document;
    ...
    value: function _resize() {
      ...
      this.timeoutId = setTimeout(function () {
        _this3.targetElem.classList.remove("is-resize");
      }, 500);
    }
  }]);
...
var Toggle = /*#__PURE__*/function () {
  function Toggle(ele, options) {
    ...
    this.options = Object.assign(this.defaultOptions, options);
    this.objectName = ele.substring(4); // フォーカス
    ...
    if (this.options.relation !== false) {
      if (Array.isArray(this.options.relation)) {
        ...
        this.options.relation.forEach(function (val) {
          _this.DOM.relation.push(document.querySelector(val));

          _this.relationObjectName.push(val.substring(4));
        });
      } else {
    ...
    if (this.DOM.btn !== null) {
      this.DOM.btn.forEach(function (elem) {
        elem.addEventListener("click", _this._toggle.bind(_this), {
          passive: true
        });
      });
    }
  ...
  _createClass(Toggle, [{
    ...
    value: function _toggle(e) {
      ...
      var isExpanded = e.currentTarget.getAttribute("aria-expanded") !== "false";
      e.currentTarget.setAttribute("aria-expanded", !isExpanded); // activeのクラス名

      if (this.options.activeClass) {
        var activeClass = e.currentTarget.getAttribute("data-active");
      ...
      if (this.options.label) {
        var label = isExpanded ? this.options.label.open : this.options.label.close;
        e.currentTarget.querySelector(this.options.label.el).innerText = label;
      }

      this.DOM.target.classList.toggle("is-".concat(this.objectName, "Active")); // relation

      if (this.options.relation !== false) {
        if (Array.isArray(this.options.relation)) {
          this.DOM.relation.forEach(function (val, i) {
            if (val !== null) {
              val.setAttribute("aria-expanded", !isExpanded);

              _this2.DOM.target.classList.remove("is-".concat(_this2.relationObjectName[i], "Active"));
            }
          });
        } else {
          this.DOM.relation.setAttribute("aria-expanded", !isExpanded);
          this.DOM.target.classList.remove("is-".concat(this.relationObjectName, "Active"));
        }
      } // aria-hidden


      if (this.options.hiddenTarget !== false) {
        var isHidden = this.DOM.hiddenTarget.getAttribute("aria-hidden") !== "false";
...
/***/ "./src/assets/js/lib/closet.polyfill.js":
/*!**********************************************!*\
  !*** ./src/assets/js/lib/closet.polyfill.js ***!
  \**********************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _lib_closet_polyfill__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./lib/closet.polyfill */ "./src/assets/js/lib/closet.polyfill.js");
/* harmony import */ var _lib_Loading__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./lib/Loading */ "./src/assets/js/lib/Loading.js");
/* harmony import */ var _lib_Toggle__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./lib/Toggle */ "./src/assets/js/lib/Toggle.js");
/* harmony import */ var _lib_Accordion__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./lib/Accordion */ "./src/assets/js/lib/Accordion.js");
...
(0,_lib_closet_polyfill__WEBPACK_IMPORTED_MODULE_2__["default"])(); // Libraly
...
new _lib_Loading__WEBPACK_IMPORTED_MODULE_3__["default"](); // new SmoothScroll('a[href*="#"]');

new _lib_Toggle__WEBPACK_IMPORTED_MODULE_4__["default"](".js-drawer");
new _lib_Accordion__WEBPACK_IMPORTED_MODULE_5__["default"]();
new (scroll_hint__WEBPACK_IMPORTED_MODULE_6___default())(".js-scroll", {
  enableOverflowScrolling: true,
  i18n: {
